// we can create global variables (height/width) and remove these variables from the other chart's js file.
// or we can wrap them in immediately invoked functions
